...
OrbbecCameraSplitterNode::OrbbecCameraSplitterNode(
  ...
  timesync_infra_1_->registerCallback(
      std::bind(&OrbbecCameraSplitterNode::image1Callback, this,
  ...
  timesync_infra_2_->registerCallback(
      std::bind(&OrbbecCameraSplitterNode::image2Callback, this,
                std::placeholders::_1, std::placeholders::_2));
  ...
  timesync_depth_->registerCallback(
      std::bind(&OrbbecCameraSplitterNode::depthCallback, this,
                std::placeholders::_1, std::placeholders::_2));
  ...
  timesync_pointcloud_->registerCallback(
      std::bind(&OrbbecCameraSplitterNode::pointcloudCallback, this,
                std::placeholders::_1, std::placeholders::_2));

  // Publisher
  constexpr size_t kOutputQueueSize = 10;
  const auto output_qos = rclcpp::QoS(rclcpp::KeepLast(kOutputQueueSize),
...
void OrbbecCameraSplitterNode::depthCallback(
    sensor_msgs::msg::Image::ConstSharedPtr image,
    orbbec_camera_msgs::msg::Metadata::ConstSharedPtr metadata) {
  republishIfEmitterMode<sensor_msgs::msg::Image>(image, metadata,
