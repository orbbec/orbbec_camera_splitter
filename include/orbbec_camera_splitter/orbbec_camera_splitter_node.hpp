...
class OrbbecCameraSplitterNode : public rclcpp::Node
{
public:
  explicit OrbbecCameraSplitterNode(const rclcpp::NodeOptions & options);
  virtual ~OrbbecCameraSplitterNode() = default;
...
private:
  ...
  typedef message_filters::sync_policies::ExactTime<
      sensor_msgs::msg::Image, orbbec_camera_msgs::msg::Metadata>
    image_time_policy_t;
  typedef message_filters::sync_policies::ExactTime<
      sensor_msgs::msg::PointCloud2, orbbec_camera_msgs::msg::Metadata>
  ...
  message_filters::Subscriber<orbbec_camera_msgs::msg::Metadata>
